...
#  GT Location
#
set_property LOC GTF_COMMON_X1Y6   [get_cells -hierarchical -filter {NAME =~ i_gtfraw/example_gtf_common_inst/gtf_common_inst}]
set_property LOC GTF_CHANNEL_X1Y24 [get_cells -hierarchical -filter {NAME =~ i_gtfraw/gen_blk_multi_ch[0].u_gtf_wiz_ip_top/inst/gtf_channel_inst/gtf_channel_inst}]
...
#
#################################################################################
create_generated_clock -name CLK_RXOUTCLK [get_pins i_gtfraw/gen_blk_multi_ch[0].u_gtf_wiz_ip_top/inst/gtf_channel_inst/gtf_channel_inst/RXOUTCLK]
create_generated_clock -name CLK_TXOUTCLK [get_pins i_gtfraw/gen_blk_multi_ch[0].u_gtf_wiz_ip_top/inst/gtf_channel_inst/gtf_channel_inst/TXOUTCLK]
