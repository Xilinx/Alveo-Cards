...
add_files -norecurse -fileset constrs_1 ${_origin_dir_}/XDC/gtfraw_vnc_top.xdc
...
#set_property CONFIG.PRESET {GTF-10G-RAW} [get_ips gtfwizard_0]
...
set_property -dict [list \
  CONFIG.Coe_File ${_origin_dir_}/RTL/tx_gen/bram.coe \
  CONFIG.Load_Init_File {true} \
] [get_ips blk_mem_gen_0]
generate_target {instantiation_template} [get_files ${_proj_path_}/${_proj_name_}.srcs/sources_1/ip/blk_mem_gen_0/blk_mem_gen_0.xci]
...
set_property top gtfraw_vnc_top [current_fileset]
