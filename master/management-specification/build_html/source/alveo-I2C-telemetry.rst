...
.. tip:: AMD recommends waiting for 1-2 ms between any two I2C transactions. Without the delay, uninterrupted I2C operation is not guaranteed.

.. note:: For U55C SC 7.1.20 and higher, there is some overlap between PLDM and I2C telemetry.
   For these cases, use :doc:`PLDM <./pldm-t2-telemetry>` values.
