...
.. note:: Effecter commands are supported only in the Alveo™ MA35D product.
...
.. note:: Effecter values range between 0x00 and 0x01. For ASIC/SC resets, sending 0x01 results in reset. For flash Write Protects, sending 0x00 disables WP and 0x01 enables it back.
