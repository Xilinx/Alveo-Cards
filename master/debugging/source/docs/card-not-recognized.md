...
-  If the card is installed in the system, try a [warm reboot](#reboot-warm-boot-reset-system).
...
As a last attempt:
- [Cold boot](#cold-boot-power-cycle) the system twice
...
- [Cold boot](#cold-boot-power-cycle) the system
...
- [Cold boot](#cold-boot-power-cycle) the system and see if the card is recognized
- [Warm reboot](#reboot-warm-boot-reset-system) and see if the card is recognized
