...
Starting with the 2021.1 version of XRT, there are new default subcommands for the xbmgmt and xbutil tools. The new commands are the future and we encourage migration.

For full details on the updated commands, please see the XRT documentation:
- [Next generation xbutil](https://xilinx.github.io/XRT/master/html/xbutil.html)
- [Next generation xbmgmt](https://xilinx.github.io/XRT/master/html/xbmgmt.html)
- [Map from legacy commands to next generation commands](https://xilinx.github.io/XRT/master/html/xbtools_map.html)



If you are using the 2021.1 version of XRT, legacy commands can be executed by adding `--legacy` switch as part of the command.
