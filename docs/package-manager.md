...
```
This error can occur if XRT is built from GitHub sources without Vitis software platform installed and `XILINX_VITIS` set

Next steps:
- Prior to building XRT from GitHub sources, install the Vitis software platform and set up the Vitis Environment.
- See [Vitis Unified Software Platform Documentation](https://www.xilinx.com/html_docs/xilinx2020_1/vitis_doc/index.html).
- - -
...
```
[root@xcowtsalveo1 ~]# /opt/xilinx/xrt/bin/xbmgmt flash --update --shell xilinx_u250_gen3x16_base_2
