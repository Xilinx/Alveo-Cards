...
proc create_root_design { parentCell } {
  ...
  set_property CONFIG.C_MON_TYPE {INTERFACE} $system_ila_2
...
connect_bd_intf_net -intf_net [get_bd_intf_nets xdma_0_M_AXI_B] [get_bd_intf_pins axi_interconnect_0/S00_AXI] [get_bd_intf_pins system_ila_2/SLOT_0_AXI]
  ...
  connect_bd_net -net s_axi_aclk_1 [get_bd_pins xdma_0/axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins system_ila_2/clk]
  connect_bd_net -net s_axi_aresetn_1 [get_bd_pins xdma_0/axi_aresetn] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins system_ila_2/resetn]
